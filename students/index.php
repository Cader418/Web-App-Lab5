    ...
    <script>
        function generateCards(){
            ...
            for(var i = 0; i < len; i++){ //Print each on cards
                //Display info
                document.getElementById('courses').innerHTML += ("<b>Course:</b> " + course_name[i] + "<br><b>Professor:</b> " + fac_id[i]
            ...
            for(var i = 0; i < len; i++){ //Print each on cards
                //Display info
                document.getElementById('faculty').innerHTML += ("<b>Faculty:</b> " + faculty_name[i] + "<br><b>Date of Join:</b> " + fac_DOJ[i]
                + "<br><b>Qualification:</b> " + qualification[i] + "<br><b>Department:</b> " + department[i] + "</br>");
            }
            //Student Lists
            ...
            for(var i = 0; i < len; i++){ //Print each on cards
                //Display info
                document.getElementById('you').innerHTML += ("<b>Name:</b> " + student_name[i] + "<br><b>Major:</b> " + major[i]
                + "<br><b>GPA:</b> " + GPA[i] + "<br><b>Enrollment Year:</b> " + YOE[i] + "<br><b>Expected Graduation:</b> " + YOG[i] + "</br>");
            }
        }
    </script>
</head>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">STUDENT PAGE</span>
